...
Date: 2026-03-27
Tags: certificate, ssl, openssl, ansible, bash, automation
...
[`certificate_expiry.sh`](https://github.com/marcin93/automation/blob/main/ssl_certificate_expiry/certificate_expiry.sh)
...
[`check_local_cert_expiry.yml`](https://github.com/marcin93/automation/blob/main/ssl_certificate_expiry/check_local_cert_expiry.yml)
